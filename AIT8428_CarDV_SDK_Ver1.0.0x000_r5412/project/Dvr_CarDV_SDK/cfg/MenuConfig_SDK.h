...
#define MENU_MOVIE_SIZE_1080P_EN                	(0)
...
#define MENU_MOVIE_NIGHT_MODE_EN              	    (0)
...
#if (SUPPORT_GSENSOR)
#define MENU_GENERAL_GSENSOR_EN                 	(GSENSOR_3_LEVEL)
#else
#define MENU_GENERAL_GSENSOR_EN                 	(0)
#endif	// SUPPORT_GSENSOR

#define MENU_MOVIE_GSENSOR_SENSITIVITY_XYZ_EN       (1)

#define MENU_GENERAL_POWERON_GSENSOR_EN             (POWER_ON_BY_GSENSOR_EN & 0)
