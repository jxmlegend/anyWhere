...
#define GSENSOR_MODULE_DA380		(6)
#define GSENSOR_MODULE_DA380ANDSC7A30E		(7)

#define GSENSOR_MODULE				(GSENSOR_MODULE_DA380ANDSC7A30E) //GSENSOR_MODULE_RT3000 / GSENSOR_MODULE_LIS3DH /
...
#define GSENSOR_DETECT_MODE			(GSNESOR_DETECT_DIFF)
...
/* 3-Level Setting */
#define	GSNR_SENS_3LEVEL0			GR(0.20)
#define	GSNR_SENS_3LEVEL1			GR(0.60)
#define	GSNR_SENS_3LEVEL2			GR(1.0)
...
/* LDWS setting */
#define LDWS_WARN_MIN_SPEED             (0)     // undefined: default is 60KM/H, 0: for test only
/* FCWS setting */
...
#define KEY_POWER_OFF				(BUTTON_POWER_REL)	// See KeyParser
...
#define TOUCH_IC_PLACEMENT_TYPE					(TOUCH_PANEL_DIR_1)
#define DSC_TOUCH_PANEL                         (TOUCH_PANEL_TSC2007)
...
#define POWER_ON_BATTERY_DETECTION      (BATTERY_DETECTION_EN &0)      // For MBOOT Only
