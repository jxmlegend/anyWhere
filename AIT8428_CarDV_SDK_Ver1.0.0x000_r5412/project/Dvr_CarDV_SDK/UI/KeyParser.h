...
typedef enum _VideoRecTouchButtonID{
    ...
    VIDEO_TOUCH_SWAP_PIP=EVENT_INDEX_DV+26,//26
    VIDEO_TOUCH_SWAP_FRONT_CAM,
    VIDEO_TOUCH_SWAP_BACK_CAM,
    VIDEO_TOUCH_SWAP_FRONT_BACK_CAM,
    VIDEO_TOUCH_MUTE,
...
typedef enum _ThumbnailTouchButtonID{
    ...
    THUMB_TOUCH_ID_CHANEL1=EVENT_INDEX_THUMBNAIL+30,//15
    THUMB_TOUCH_ID_CHANEL2,//16
...
typedef enum _MovPlaybackTouchButtonID{
    ...
    MOVPB_TOUCH_ID_PREV=MOVPB_TOUCH_ID_NONE+2,
    MOVPB_TOUCH_ID_BKWD,
    MOVPB_TOUCH_ID_FRWD,
    MOVPB_TOUCH_ID_NEXT,
    ...
    MOVPB_TOUCH_ID_EXIT=MOVPB_TOUCH_ID_NONE+50,
    MOVPB_TOUCH_ID_PLAY,
    MOVPB_TOUCH_ID_DEL,
