 ...
 * Main body
 *===========================================================================*/ 
char* AHC_GetSoundEffectFileName(AHC_SOUNDEFFECT_TYPE soundtype)//leo20180630
{	
    ...
    switch(soundtype)
    {
    case AHC_SOUNDEFFECT_FORMAT_SUCCESS:
		STRCAT(path,"format_success.wav");
		break;
    case AHC_SOUNDEFFECT_FILELOCK:
		STRCAT(path,"lock.wav");
		break;
    case AHC_SOUNDEFFECT_MICON:
		STRCAT(path,"mute_on.wav");
		break;
 	case AHC_SOUNDEFFECT_MICOFF:
		STRCAT(path,"mute_off.wav");
		break;
    ...
    case AHC_SOUNDEFFECT_SPCAMRELEASE:
        STRCAT(path,"motion_parking_rec.wav");
        break;
