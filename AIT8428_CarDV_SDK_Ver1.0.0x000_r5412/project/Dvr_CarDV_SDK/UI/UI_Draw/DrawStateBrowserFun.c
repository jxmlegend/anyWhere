...
void DrawBrowser_FileInfo(UINT8 ubID)
{
    ...
    if(MaxDcfObj == 0)
    {
        //UIDrawBrowserFuncEx(ubID, BROWSER_GUI_FILENAME,  		AHC_TRUE, AHC_FALSE, OSD_TOUCH_BACKGROUND, Deleting_InBrowser || Protecting_InBrowser);	
        //UIDrawBrowserFuncEx(ubID, BROWSER_GUI_FILE_DATE, 		AHC_TRUE, AHC_FALSE, OSD_TOUCH_BACKGROUND, Deleting_InBrowser || Protecting_InBrowser);
       // UIDrawBrowserFuncEx(ubID, BROWSER_GUI_MOV_TOTAL_TIME, 	AHC_TRUE, AHC_FALSE, OSD_TOUCH_BACKGROUND, Deleting_InBrowser || Protecting_InBrowser);	
    }
    else
    {    
...
void DrawBrowser_PageInfo(UINT8 ubID)
{
    ...
    AHC_OSDSetColor(ubID, OSD_COLOR_WHITE);
    AHC_OSDSetBkColor(ubID, OSD_TOUCH_BACKGROUND);
...
void DrawBrowser_BackCurtain(UINT8 ulID)//leo20180703
{
    UINT16 osdW;
    UINT16 osdH;
   ...
   // AHC_OSDDrawFillRect( ulID, 0, (DISP_HEIGHT-BG_CURTAIN_H), BG_CURTAIN_W, DISP_HEIGHT );
    ...
    //HC_OSDSetColor(ulID, OSD_COLOR_TRANSPARENT);
...
void DrawStateBrowserInit_Lcd(void)
{
    ...
    RECT RECTChanel1= {15,5,70,70};
    RECT RECTChanel2= {135,5,70,70};
#endif
	printc("DrawStateBrowserInit \n");
...
#if (SUPPORT_TOUCH_PANEL)
       BEGIN_LAYER(bID0);
   	AHC_OSDDrawBitmap(bID0, &bmIcon_setup_bg_bar,   RECTSetupBg.uiLeft, RECTSetupBg.uiTop);
   	AHC_OSDDrawBitmap(bID0, &bmIcon_home_button_normal,   RECTSetupHome.uiLeft, RECTSetupHome.uiTop);
   	//AHC_OSDDrawBitmap(bID0, &bmIcon_1ch_button_on,   RECTChanel1.uiLeft, RECTChanel1.uiTop);
	//AHC_OSDDrawBitmap(bID0, &bmIcon_2ch_button_off,   RECTChanel2.uiLeft, RECTChanel2.uiTop);
	if(m_ubPlaybackRearCam)
	{
		AHC_OSDDrawBitmap(bID0, &bmIcon_1ch_button_off,   RECTChanel1.uiLeft, RECTChanel1.uiTop);
	    	AHC_OSDDrawBitmap(bID0, &bmIcon_2ch_button_on,   RECTChanel2.uiLeft, RECTChanel2.uiTop);
	}
	else
	{
		AHC_OSDDrawBitmap(bID0, &bmIcon_1ch_button_on,   RECTChanel1.uiLeft, RECTChanel1.uiTop);
   	...
   	AHC_OSDDrawBitmap(bID0, &bmup2_button_normal,   uRECT.uiLeft, uRECT.uiTop);
    AHC_OSDDrawBitmap(bID0, &bmdown2_button_normal, dRECT.uiLeft, dRECT.uiTop);
	AHC_OSDDrawBitmap(bID0, &bmenter_button_normal,   enRECT.uiLeft, enRECT.uiTop); 
