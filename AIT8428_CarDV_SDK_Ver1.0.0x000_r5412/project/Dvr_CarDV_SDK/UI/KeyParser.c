...
UINT32 KeyParser_VideoRecEvent(UINT32 ulMsgId, UINT32 ulEvent, UINT32 ulParam )
{
    ...
    switch( ulEvent )
    {
		...
		{	
			//printc("1111ulParam %x,%x\n",ulParam&0x0000ffff,ulParam&0xffff0000);
			if((ulParam&0x0000ffff)&&(ulParam&0xffff0000))
			{
				//printc("2222ulParam %x,%x\n",ulParam&0x0000ffff,ulParam&0xffff0000);
				return (EVENT_VIDEO_TOUCH_MENU);//AhcCheckTouchButton( &ulParam,  AHC_FALSE );
				printc("3333ulParam %x,%x\n",ulParam&0x0000ffff,ulParam&0xffff0000);
				break;
			}
 		}
		...
		case BUTTON_POWER_REL      :     return EVENT_POWER_OFF;
	...
	case BUTTON_LOCK_FILE_G    :       return EVENT_LOCK_FILE_G;
        ...
        default :     
        	//printc("default----default---default-\n");
        	return EVENT_NONE;
    }
}
...
UINT32 KeyParser_ThumbnailEvent(UINT32 ulMsgId, UINT32 ulEvent, UINT32 ulParam )
{
    ...
    switch( ulEvent )
    {
...
#endif
		//case EVENT_THUMBNAIL_TOUCH_PAGE_UP:		return EVENT_THUMBNAIL_TOUCH_PAGE_UP;//leo20180702
		//case EVENT_THUMBNAIL_TOUCH_PAGE_DOWN: 	return EVENT_THUMBNAIL_TOUCH_PAGE_DOWN;//leo20180702
		//case EVENT_THUMBNAIL_TOUCH_CHANEL1: 	return EVENT_MOVPB_MODE;//leo20180702
		//case EVENT_THUMBNAIL_TOUCH_CHANEL2: 	return EVENT_MOVPB_MODE;//leo20180702
		...
		case BUTTON_REC_PRESS      :     return EVENT_NONE;
  		case EVENT_THUMBNAIL_TOUCH_MENU      :     return EVENT_THUMBNAIL_KEY_PLAYBACK;//leo20180702
		case BUTTON_MENU_REL	   :	 return EVENT_KEY_MENU;
