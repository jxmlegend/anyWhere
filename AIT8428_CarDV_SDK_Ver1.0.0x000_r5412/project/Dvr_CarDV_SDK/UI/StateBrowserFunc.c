...
UINT32		Selectfile 			= 0;//leo20180702
UINT32		ObjSelect 			= 0;
...
void BrowserFunc_LCDSetting(void)
{
	...
	m_ThumbConfig.byBkColor       = 0x050505;
...
AHC_BOOL BrowserFunc_ThumbnailEditFilelUpdatePage(void)
{
	...
	{
		#if (TVOUT_ENABLE)
		DrawBrowserStatePageUpdate();//DrawStateTVBrowserUpdate();
		#endif
	}
...
DECL_AHC_EV_HANDLER(STATE_BROWSER_MODE_EVENT_KEY_MODE)
{
	...
	printc("STATE_BROWSER_MODE_EVENT_KEY_MODE--GetCurrentOpMode()=%d\n",GetCurrentOpMode());
	{
#if (CYCLIC_MODE_CHANGE)
			{
				...
				{
					printc("STATE_BROWSER_MODE_EVENT_KEY_MODE---UI_BROWSER_STATE\n");
					if(Delete_File_Confirm || Protect_File_Confirm || UnProtect_File_Confirm)
						return;
			...
			printc("STATE_BROWSER_MODE_EVENT_KEY_MODE---ubNextMode=%d\n",ubNextMode);
...
//	}else
//#endif
	printc("STATE_BROWSER_MODE_EVENT_MOVPB_MODE\n");
	{
		if( GetCurrentOpMode() == MOVPB_MODE || GetCurrentOpMode() == JPGPB_MODE || GetCurrentOpMode() == JPGPB_MOVPB_MODE)
		{
			...
			AHC_Thumb_DrawPage(AHC_TRUE);
			//DrawStateBrowserUpdate(EVENT_THUMBNAIL_MODE);
			DrawStateBrowserUpdate(EVENT_THUMBNAIL_MODE_INIT);//leo20180703
		}
	}
}
...
AHC_BOOL StateSelectFuncBrowserMode(void)
{
    ...
    RegisterEventCb(EVENT_THUMBNAIL_TOUCH_PAGE_UP,						STATE_BROWSER_MODE_EVENT_KEY_UP);//leo20180702
    RegisterEventCb(EVENT_THUMBNAIL_TOUCH_PAGE_DOWN,						STATE_BROWSER_MODE_EVENT_KEY_DOWN);//leo20180702
    ...
    //leo20180703
    RegisterEventCb(EVENT_THUMBNAIL_TOUCH_MENU,		STATE_BROWSER_MODE_EVENT_THUMBNAIL_KEY_PLAYBACK);
    ...
    //leo20180709
    RegisterEventCb(EVENT_THUMBNAIL_TOUCH_MODE,						STATE_BROWSER_MODE_EVENT_KEY_MODE);
    //leo20180703
    RegisterEventCb(EVENT_THUMBNAIL_TOUCH_CHANEL1,			STATE_BROWSER_MODE_EVENT_MOVPB_MODE);
    RegisterEventCb(EVENT_THUMBNAIL_TOUCH_CHANEL2,			STATE_BROWSER_MODE_EVENT_MOVPB_MODE);
