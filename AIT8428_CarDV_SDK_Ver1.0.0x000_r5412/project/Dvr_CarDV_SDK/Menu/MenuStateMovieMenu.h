...
// Menu Order - 1080@30fps, 720@30fps, 720@60fps, VGA@30fps
    ...
    ITEMID_MOVIE_VOLT_8,
    ITEMID_MOVIE_VOLT_9,
    ITEMID_MOVIE_VOLT_10,
    ITEMID_MOVIE_VOLT_11,
    ITEMID_MOVIE_VOLT_12,
     ITEMID_MOVIE_VOLT_13,
    ITEMID_MOVIE_VOLT_14,
    ITEMID_MOVIE_VOLT_15,
	ITEMID_MOVIE_PARKING_REC,
    ITEMID_MOVIE_EVENT_REC,
    ITEMID_MOVIE_REC_BOTTON,
