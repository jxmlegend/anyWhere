...
#if (MENU_GENERAL_CLOCK_SETTING_EN)
UINT32 SubMenuEventHandler_ClockSetting1(PSMENUSTRUCT pMenu, UINT32 ulEvent, UINT32 ulParam)

{
    INT32 	iPrevPos;
    POINT	TouchPoint;
	//printc("SubMenuEventHandler_ClockSetting1ulEvent %d,iMenuId %d\r\n",ulEvent,pMenu->iMenuId); 
