...
typedef enum{
	...
	MENUID_SUB_MENU_SETTINGVOLT1,//210
...
extern SMENUSTRUCT  sSubMovieSetting;
...
#define	BAR_STATA_NORMAL	 	0
#define   BAR_STATA_PUSH		1
typedef struct {
...
extern SMENUTOUCHBUTTON VideoMainPage_TouchButton[7];
extern SMENUTOUCHBUTTON VideoCtrlPage_TouchButton[7];
extern SMENUTOUCHBUTTON CaptureMainPage_TouchButton[3];
extern SMENUTOUCHBUTTON CaptureCtrlPage_TouchButton[6];
extern SMENUTOUCHBUTTON Browser_TouchButton[10];
...
extern SMENUTOUCHBUTTON SubMenuPLAYBACK_TouchButton[4];

extern SMENUTOUCHBUTTON MainMenu_TouchButton[8];
extern SMENUTOUCHBUTTON SubMenu2_TouchButton[3];
extern SMENUTOUCHBUTTON SubMenu2_TouchButton1[3];
extern SMENUTOUCHBUTTON SubMenu2e_TouchButton1[3]; // lyj
extern SMENUTOUCHBUTTON SubMenu2c_TouchButton1[3]; // lyj
extern SMENUTOUCHBUTTON SubMenu3_TouchButton[4];
extern SMENUTOUCHBUTTON SubMenu3e_TouchButton[4]; //lyj
extern SMENUTOUCHBUTTON SubMenu4_TouchButton[5];
extern SMENUTOUCHBUTTON SubMenu5e_TouchButton[6];
extern SMENUTOUCHBUTTON SubMenu6_TouchButton[7];
extern SMENUTOUCHBUTTON SubMenu7_TouchButton[8];
...
extern SMENUTOUCHBUTTON SubMenusetvoice_TouchButton[7];
extern SMENUTOUCHBUTTON SubMenusetvolt_TouchButton[6];
extern SMENUTOUCHBUTTON SubMenu_settingtime[9];
extern SMENUTOUCHBUTTON Touchadjust_TouchButton[1];
extern SMENUTOUCHBUTTON SubMenu8_TouchButton[9];
...
#define	MENU_MAIN3_PRESS			27
#define	MENU_MAIN3_MOVE				127
//////////////////////////////////////////////////////////////////////////////////////////////////////							
