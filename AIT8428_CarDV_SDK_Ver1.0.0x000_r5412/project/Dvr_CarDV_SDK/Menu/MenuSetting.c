...
AHC_BOOL Menu_WriteSetting(void)
{
	...
	printc("Menu_WriteSetting--MenuSettingConfig()->uiSlideShowEffect=%d\n",MenuSettingConfig()->uiSlideShowEffect);
	printc("Menu_WriteSetting--MenuSettingConfig()->uiLCDBrightness=%d\n",MenuSettingConfig()->uiLCDBrightness);
...
void MenuSettingInit(void)
{
    ...
    gCurMenuInfo.uiSlideShowMusic   	= 2;
    gCurMenuInfo.uiVolume           	= VOLUME_10;
    ...
    gCurMenuInfo.uiBeep             	= 1;
    gCurMenuInfo.uiLCDBrightness    	= 3;
    gCurMenuInfo.uiAutoPowerOff     	= AUTO_POWER_OFF_NEVER;
    gCurMenuInfo.uiDateTimeSetup    	= 1;
	...
	gCurMenuInfo.uiGsensorSensitivity 	=  2;
...
{
		MenuSettingConfig()->uiHDMIOutput = 1;//logo
		MenuSettingConfig()->uiMOVSoundRecord=0;//是否静音
		MenuSettingConfig()->uiGsensorSensitivity=2;//gsensor 灵敏度
		MenuSettingConfig()->uiLCDBrightness=2;//关屏时间
		MenuSettingConfig()->uiRecordGPS=0;
		MenuSettingConfig()->uiGPSStamp=0;//gps on/off
		MenuSettingConfig()->uiSlideShowEffect=5;//电压选项
		MenuSettingConfig()->uiVolume=10;//声音大小
		MenuSettingConfig()->uiWDR=0;//format
			//MenuSettingConfig()->uiSlideShowMusic=0;
		MenuSettingConfig()->uiBeep = 0;//声音on/off
		MenuSettingConfig()->uiMOVSize=0;
}
...
AHC_BOOL CheckMenuSetting(MenuInfo* CurMenu)
{
	...
	MenuSettingInRange(&(CurMenu->uiSlideShowEffect), 	0, 	15	);
	MenuSettingInRange(&(CurMenu->uiSlideShowMusic), 	0, 	5-1	);
	...
	MenuSettingInRange(&(CurMenu->uiLCDBrightness), 	0, 	3	);
	MenuSettingInRange(&(CurMenu->uiAutoPowerOff), 		0, 	AUTO_POWER_OFF_NUM-1	);
	MenuSettingInRange(&(CurMenu->uiDateTimeSetup), 	0, 	9						);
	...
	MenuSettingInRange(&(CurMenu->uiGPSStamp), 			0, 	15		);
	...
	MenuSettingInRange(&(CurMenu->uiHDMIOutput), 		0, 	HDMI_OUTPUT_NUM		);
	...
	MenuSettingInRange(&(CurMenu->uiUSBFunction), 		0, 	1				);
	...
	MenuSettingInRange(&(CurMenu->uiWNR),		        0, 	15	);
...
static MENU_ATOMS  menu_atoms =
{
    ...
    NUMBER_SETTING,
    {
        ...
        {/* 031 */"SlideShowEffect",    0, MENU_PLAYBACK_SLIDESHOW_EFFECT_EN,   0, 15,ParamFun, NULL,     "Effect:0:Simple, see this submenu for others"},
        ...
        {/* 038 */"LCDBrightness",  0, MENU_GENERAL_LCD_BRIGHTNESS_EN,  0, 3,          ParamFun, NULL,     szReserved},
		...
		{/* 066 */"touchx1",			0, 1,								0,255,								ParamFun, NULL, 	szReserved},
		{/* 066 */"touchx2",			0, 1,								0, 255,								ParamFun, NULL, 	szReserved},
		{/* 066 */"touchy1",			0, 1,								0,255,								ParamFun, NULL, 	szReserved},
		{/* 066 */"touchy2",			0, 1,								0,255,								ParamFun, NULL, 	szReserved},
		{/* 066 */"touchk1",			0, 1,								0,255,								ParamFun, NULL, 	szReserved},
		{/* 066 */"touchk2",			0, 1,								0, 255,								ParamFun, NULL, 	szReserved},
		{/* 066 */"touchk3",			0, 1,								0,255,								ParamFun, NULL, 	szReserved},
		{/* 066 */"touchk4",			0, 1,								0,255,								ParamFun, NULL, 	szReserved},
		{/* 066 */"touchk5",			0, 1,								0,255,								ParamFun, NULL, 	szReserved},
	...
	{/* 089 */REARCAM_MIRROR_KEY,  0, MENU_GENERAL_REARCAM_MIRROR_EN,		0, REARCAM_MIRROR_NUM - 1,				pf_General, Menu_Setting_Get_General, 	szReserved},
        {/* 090 */COMMON_KEY_B_VOL,       0, 1,               0, 4096,   pf_General, Menu_Setting_Get_General,  szReserved},
