...
#define OSD_MENU_EXIT_X				(167)
#define OSD_MENU_EXIT_Y				(0)
#define OSD_MENU_EXIT_W				(145)
#define OSD_MENU_EXIT_H				(90)

#define OSD_MENU_EXIT_THIRD_X				(335)
#define OSD_MENU_EXIT_THIRD_Y				(0)
#define OSD_MENU_EXIT_THIRD_W				(145)
#define OSD_MENU_EXIT_THIRD_H				(70)
...
#define OSD_MENU_ITEM_TOUCH_INTERVAL	5
...
//Main Menu
#define OSD_MAINMENU3_X				(25)//modify accroding custom file
#define OSD_MAINMENU3_Y				(55)
#define OSD_MAINMENU3_W	       		(150)
#define OSD_MAINMENU3_H				(110)

#define OSD_MAINMENU0_X				(25)
#define OSD_MAINMENU0_Y				(175)
#define OSD_MAINMENU0_W	       		(150)
#define OSD_MAINMENU0_H				(110)

#define OSD_MAINMENU1_X				(185)
#define OSD_MAINMENU1_Y         			(175)
#define OSD_MAINMENU1_W		    		(150)
#define OSD_MAINMENU1_H				(110)

#define OSD_MAINMENU2_X				(345)
#define OSD_MAINMENU2_Y         			(175)
#define OSD_MAINMENU2_W		    		(110)
#define OSD_MAINMENU2_H				(110)
//Sub Menu
#define OSD_SUBMENU20_X				(250)
#define OSD_SUBMENU20_Y				(215)
#define OSD_SUBMENU20_W				(85)
#define OSD_SUBMENU20_H				(55)

#define OSD_SUBMENU21_X				(355)
#define OSD_SUBMENU21_Y				(215)
#define OSD_SUBMENU21_W	       		(85)
#define OSD_SUBMENU21_H				(55)

#define OSD_SUBMENU22_X				(20)
#define OSD_SUBMENU22_Y				(150)
#define OSD_SUBMENU22_W				(210)
#define OSD_SUBMENU22_H				(80)

#define OSD_SUBMENU23_X				(250)
#define OSD_SUBMENU23_Y				(150)
#define OSD_SUBMENU23_W	       		(210)
#define OSD_SUBMENU23_H				(80)

#define OSD_SUBMENUPLAYBACK_X				(60)
#define OSD_SUBMENUPLAYBACK_Y				(150)
#define OSD_SUBMENUPLAYBACK1_X				(190)
#define OSD_SUBMENUPLAYBACK2_X				(320)
#define OSD_SUBMENUPLAYBACK_W				(100)
#define OSD_SUBMENUPLAYBACK_H				(115)

#define OSD_SUBMENU30_X				(70)
#define OSD_SUBMENU30_Y				(215)
#define OSD_SUBMENU30_W				(90)
#define OSD_SUBMENU30_H				(70)

#define OSD_SUBMENU31_X				(195)
#define OSD_SUBMENU31_Y				(215)
#define OSD_SUBMENU31_W	       		(90)
#define OSD_SUBMENU31_H				(70)

#define OSD_SUBMENU32_X				(320)
#define OSD_SUBMENU32_Y				(215)
#define OSD_SUBMENU32_W	       		(90)
#define OSD_SUBMENU32_H				(70)

#define OSD_SUBMENU40_X				(30)
#define OSD_SUBMENU40_Y             		(155)
#define OSD_SUBMENU40_W				(90)
#define OSD_SUBMENU40_H				(70)

#define OSD_SUBMENU41_X				(140)
#define OSD_SUBMENU41_Y				(155)
#define OSD_SUBMENU41_W				(90)
#define OSD_SUBMENU41_H				(70)

#define OSD_SUBMENU42_X				(250)
#define OSD_SUBMENU42_Y				(155)
#define OSD_SUBMENU42_W	       		(90)
#define OSD_SUBMENU42_H				(70)

#define OSD_SUBMENU43_X				(360)
#define OSD_SUBMENU43_Y             		(155)
#define OSD_SUBMENU43_W				(90)
#define OSD_SUBMENU43_H				(70)

#define OSD_SUBMENU60_X				(85)
#define OSD_SUBMENU60_Y				(110)
#define OSD_SUBMENU60_W				(100)
#define OSD_SUBMENU60_H				(100)

#define OSD_SUBMENUCLOCK_X0				(25)
#define OSD_SUBMENUCLOCK_X1				(155)
#define OSD_SUBMENUCLOCK_X2				(255)
#define OSD_SUBMENUCLOCK_X3				(360)
#define OSD_SUBMENUCLOCK_X4			(60)


#define OSD_SUBMENUCLOCK_Y3				(110)

#define OSD_SUBMENUCLOCK_Y0				(115)
#define OSD_SUBMENUCLOCK_Y1				(215)

#define OSD_SUBMENUCLOCK_W1				(100)
#define OSD_SUBMENUCLOCK_W3				(80)

#define OSD_SUBMENUCLOCK_W2				(60)

#define OSD_SUBMENUCLOCK_H1				(70)

#define OSD_SUBMENUCLOCK_H				(60)

#define OSD_SUBMENUVOLT_W				(90)
#define OSD_SUBMENUVOLT_H				(70)
#define OSD_SUBMENUVOICE1_W				(80)

#define OSD_SUBMENU61_X				(190)
#define OSD_SUBMENU61_Y				(110)
#define OSD_SUBMENU61_W	       		(100)
#define OSD_SUBMENU61_H				(100)

#define OSD_SUBMENU62_X				(295)
#define OSD_SUBMENU62_Y            			(110)
#define OSD_SUBMENU62_W				(100)
#define OSD_SUBMENU62_H				(100)

#define OSD_SUBMENU63_X				(35)
#define OSD_SUBMENU63_Y				(215)
#define OSD_SUBMENU63_W				(100)
#define OSD_SUBMENU63_H				(100)

#define OSD_SUBMENU64_X				(140)
#define OSD_SUBMENU64_Y				(215)
#define OSD_SUBMENU64_W	       		(100)
#define OSD_SUBMENU64_H				(100)

#define OSD_SUBMENU65_X				(245)
#define OSD_SUBMENU65_Y             		(215)
#define OSD_SUBMENU65_W				(100)
#define OSD_SUBMENU65_H				(100)
#define OSD_SUBMENU66_X				(350)
#define OSD_SUBMENU66_Y             (215)
#define OSD_SUBMENU67_X				(350)
#define OSD_SUBMENU67_Y             (215)
...
#define POS_BUTTON_MENU_X0          (410)
#define POS_BUTTON_MENU_Y0          (250)
#define POS_BUTTON_MENU_W           (70)
#define POS_BUTTON_MENU_H           (70)
...
#define POS_BUTTON_SWITCH_X0        (330)
#define POS_BUTTON_SWITCH_Y0        (250)
#define POS_BUTTON_SWITCH_W         (70)
#define POS_BUTTON_SWITCH_H         (70)
...
#define POS_THUMB_AREA_X0              STRETCH_W(40)//可改变文件位置
#define POS_THUMB_AREA_Y0              STRETCH_H(100)
#define POS_THUMB_AREA_W              STRETCH_W(340)
#define POS_THUMB_AREA_H              STRETCH_H(210)
...
#define POS_MENU_EXIT_THIRD         {        OSD_MENU_EXIT_THIRD_X ,       OSD_MENU_EXIT_THIRD_Y ,        OSD_MENU_EXIT_THIRD_W ,       OSD_MENU_EXIT_THIRD_H }
...
#define POS_MAINMENU3         {        OSD_MAINMENU3_X ,       OSD_MAINMENU3_Y ,        OSD_MAINMENU3_W ,       OSD_MAINMENU3_H }
...
#define POS_SUBMENU22         {        OSD_SUBMENU22_X ,       OSD_SUBMENU22_Y ,        OSD_SUBMENU22_W ,      OSD_SUBMENU22_H  }
#define POS_SUBMENU23         {        OSD_SUBMENU23_X ,       OSD_SUBMENU23_Y ,        OSD_SUBMENU23_W ,      OSD_SUBMENU23_H  }

#define POS_SUBMENU30         {        OSD_SUBMENU30_X ,       OSD_SUBMENU30_Y ,        OSD_SUBMENU30_W ,      OSD_SUBMENU30_H  }
#define POS_SUBMENU31         {        OSD_SUBMENU31_X ,       OSD_SUBMENU31_Y ,        OSD_SUBMENU31_W ,      OSD_SUBMENU31_H  }
#define POS_SUBMENU32         {        OSD_SUBMENU32_X ,       OSD_SUBMENU32_Y ,        OSD_SUBMENU32_W ,      OSD_SUBMENU32_H  }

#define POS_SUBMENUPLAYBACK1         {        OSD_SUBMENUPLAYBACK_X ,       OSD_SUBMENUPLAYBACK_Y ,        OSD_SUBMENUPLAYBACK_W ,      OSD_SUBMENUPLAYBACK_H  }
#define POS_SUBMENUPLAYBACK2         {        OSD_SUBMENUPLAYBACK1_X ,       OSD_SUBMENUPLAYBACK_Y ,        OSD_SUBMENUPLAYBACK_W ,      OSD_SUBMENUPLAYBACK_H  }
#define POS_SUBMENUPLAYBACK3         {        OSD_SUBMENUPLAYBACK2_X ,       OSD_SUBMENUPLAYBACK_Y ,        OSD_SUBMENUPLAYBACK_W ,      OSD_SUBMENUPLAYBACK_H  }
...
#define POS_SUBMENU66         {        OSD_SUBMENU66_X ,       OSD_SUBMENU66_Y ,        OSD_SUBMENU65_W ,      OSD_SUBMENU65_H  }
#define POS_SUBMENU67         {        OSD_SUBMENU66_X ,       OSD_SUBMENU66_Y ,        OSD_SUBMENU65_W ,      OSD_SUBMENU65_H  }

#define POS_SUBMENUCLOCK         {        OSD_SUBMENUCLOCK_X0 ,       OSD_SUBMENUCLOCK_Y0 ,        OSD_SUBMENUCLOCK_W1 ,      OSD_SUBMENUCLOCK_H  }
#define POS_SUBMENUCLOCK1         {        OSD_SUBMENUCLOCK_X1 ,       OSD_SUBMENUCLOCK_Y0 ,        OSD_SUBMENUCLOCK_W2 ,      OSD_SUBMENUCLOCK_H  }
#define POS_SUBMENUCLOCK2        {        OSD_SUBMENUCLOCK_X2 ,       OSD_SUBMENUCLOCK_Y0 ,        OSD_SUBMENUCLOCK_W2 ,      OSD_SUBMENUCLOCK_H  }
#define POS_SUBMENUCLOCK3         {        OSD_SUBMENUCLOCK_X3 ,       OSD_SUBMENUCLOCK_Y0 ,        OSD_SUBMENUCLOCK_W3,      OSD_SUBMENUCLOCK_H1  }
#define POS_SUBMENUCLOCK4         {        OSD_SUBMENUCLOCK_X4 ,       OSD_SUBMENUCLOCK_Y1 ,        OSD_SUBMENUCLOCK_W2 ,      OSD_SUBMENUCLOCK_H  }
#define POS_SUBMENUCLOCK5         {        OSD_SUBMENUCLOCK_X1 ,       OSD_SUBMENUCLOCK_Y1 ,        OSD_SUBMENUCLOCK_W2 ,      OSD_SUBMENUCLOCK_H  }
#define POS_SUBMENUCLOCK6         {        OSD_SUBMENUCLOCK_X2 ,       OSD_SUBMENUCLOCK_Y1 ,        OSD_SUBMENUCLOCK_W2 ,      OSD_SUBMENUCLOCK_H  }
#define POS_SUBMENUCLOCK7         {        OSD_SUBMENUCLOCK_X3 ,       OSD_SUBMENUCLOCK_Y1 ,        OSD_SUBMENUCLOCK_W3 ,      OSD_SUBMENUCLOCK_H1  }

#define POS_SUBMENUsetvolt1         {        (40) ,       (115) ,        OSD_SUBMENUVOLT_W ,      OSD_SUBMENUVOLT_H  }
#define POS_SUBMENUsetvolt2        {        (150) ,    (115) ,   OSD_SUBMENUVOLT_W ,        OSD_SUBMENUVOLT_H }
#define POS_SUBMENUsetvolt3       {       (40) ,    (215) ,       OSD_SUBMENUVOLT_W ,        OSD_SUBMENUVOLT_H   }
#define POS_SUBMENUsetvolt4       {        (150) ,    (215) ,       OSD_SUBMENUVOLT_W ,        OSD_SUBMENUVOLT_H   }
#define POS_SUBMENUsetvolt5       {       (270) ,    (215) ,        OSD_SUBMENU64_W ,      OSD_SUBMENU64_H  }

#define POS_SUBMENUsetvoice1         {        (205) ,       (115) ,        OSD_SUBMENUVOICE1_W ,      OSD_SUBMENUVOLT_H  }
#define POS_SUBMENUsetvoice2        {        (290) ,    (115) ,   OSD_SUBMENUVOICE1_W ,        OSD_SUBMENUVOLT_H }
#define POS_SUBMENUsetvoice3       {       (375) ,    (115) ,       OSD_SUBMENUVOICE1_W ,        OSD_SUBMENUVOLT_H   }
#define POS_SUBMENUsetvoice0       {        (120) ,    (115) ,       OSD_SUBMENUVOICE1_W ,        OSD_SUBMENUVOLT_H   }
#define POS_SUBMENUsetvoicey       {       (240) ,    (215) ,        (109) ,      OSD_SUBMENUVOLT_H  }
#define POS_SUBMENUsetvoicen       {       (360) ,    (215) ,        (109) ,      OSD_SUBMENUVOLT_H  }
...
#define POS_THUMB_CHANEL1      	{        15 ,        5 ,          110,         70 }
#define POS_THUMB_CHANEL2     {       135 ,       5 ,        110 ,      70 }
#define POS_THUMB_PGUP        {        365 ,        105 ,          90,         50 }
#define POS_THUMB_PGDOWN      {       365 ,       245 ,        90 ,      50 }
