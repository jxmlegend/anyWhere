...
static GUI_CONST_STORAGE GUI_COLOR Colorsdel_button_null[] = {
...
static GUI_CONST_STORAGE GUI_LOGPALETTE Paldel_button_null = {
  256,	/* number of entries */
  0, 	/* No transparency */
  &Colorsdel_button_null[0]
};

static GUI_CONST_STORAGE unsigned char acdel_button_null[] = {
...
GUI_CONST_STORAGE GUI_BITMAP bmdel_button_null = {
  60, /* XSize */
  55, /* YSize */
  60, /* BytesPerLine */
  8, /* BitsPerPixel */
  acdel_button_null,  /* Pointer to picture data (indices) */
  &Paldel_button_null  /* Pointer to palette */
};
