...
typedef struct _3RD_PARTY_TOUCHPANEL
{
    ...
    MMP_ERR (*MMPF_TouchPanel_IOControl)(struct _3RD_PARTY_TOUCHPANEL *, TOUCHPANEL_ATTR *ptouchpanel_attr, MMP_UBYTE cmd, MMP_USHORT* arg);
    //5
...
MMP_ERR MMPF_3RDParty_TouchPanel_IOControl(MMP_UBYTE cmd, MMP_USHORT* arg);
