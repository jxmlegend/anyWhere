...
typedef enum _KeyEventID {
    ...
    EVENT_VIDREC_UPDATE_MESSAGE,
     EVENT_VIDEO_TOUCH_SWAP_PIP			,//26
     EVENT_VIDEO_TOUCH_SWAP_FRONT_CAM,
     EVENT_VIDEO_TOUCH_SWAP_BACK_CAM,
     EVENT_VIDEO_TOUCH_SWAP_FRONT_BACK_CAM,
    EVENT_VIDEO_TOUCH_MUTE,
    EVENT_DESK_CLOCK_UPDATE,
    // [Browser Mode]
    ...
    EVENT_THUMBNAIL_TOUCH_CHANEL1=EVENT_INDEX_THUMBNAIL+INDEX_TOUCH_OFFSET+30,//leo20180702
     EVENT_THUMBNAIL_TOUCH_CHANEL2,
    // [Video Playback Mode]
   ...
   EVENT_MOVPB_TOUCH_EXIT=EVENT_MOVPB_TOUCH_RETURN+49,
   EVENT_MOVPB_TOUCH_PLAY_STOP				   ,
   EVENT_MOVPB_TOUCH_DEL,
    // [Photo Playback Mode]
